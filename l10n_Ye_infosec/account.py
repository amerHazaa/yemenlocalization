...
class account_journal(osv.osv):
    ...
    def create_sequence(self, cr, uid, vals, context=None):
        """ important : to Create new no_gap entry sequence for every new Joural
        """
        ## in account.journal code =  prefix of the sequence
        # whereas ir.sequence code = a key to lookup global sequences.            
